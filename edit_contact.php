...
<body style="background-color:black;">
    <div class="container mt-3" style="width: 600px">
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"])?>">
            ...
            <input type="text" class="form-control mt-2" name="address" placeholder="Address" value='<?php echo $address ?>'>
            <label class="mt-2" for="phone" style="color:white;">Phone number</label>
            <input type="text" class="form-control mt-2" name="phone" placeholder="Phone number" value='<?php echo $phone ?>'>

            <div class="row">
                <div class="col">
                    <input type="submit" class="form-control btn mt-3" name="submit" value="Submit" style="background-color:#FF8C00; color:white;">
                </div>
                <div class="col">
                    <input type="submit" class="form-control btn btn-danger mt-3" name="submit" value="Clear">
                </div>
            </div>
            <a class="form-control btn btn-secondary mt-3" href="index_admin.php">Cancel</a><br>
